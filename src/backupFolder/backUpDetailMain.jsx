      ...
      <StyledDetailInformationDivBox>
        ...
        <StyledDetailInformationSubBox>
          ...
          <StyledDetailInformationVariableText>
            {" "}
            {sameIdTodos && sameIdTodos.userName}
          </StyledDetailInformationVariableText>
        </StyledDetailInformationSubBox>
        ...
        <StyledDetailInformationSubBox>
          ...
          <StyledDetailInformationVariableText>
            {todosSchedule === "0" ? "시작 전" : null}
            {todosSchedule === "1" ? "시작 예정" : null}
            {todosSchedule === "2" ? "진행 중" : null}
            {todosSchedule === "3" ? "완료" : null}
          </StyledDetailInformationVariableText>
        </StyledDetailInformationSubBox>
